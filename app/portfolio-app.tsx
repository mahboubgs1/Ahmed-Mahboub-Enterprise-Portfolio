...
export default function PortfolioApp(){
  ...
  return <main>
    ...
    {view==="overview"&&<>
      ...
      <section className="contact"><div><span className="eyebrow">Let’s connect</span><h2>Building enterprise systems that leaders can trust.</h2></div><div className="contact-links"><a href="mailto:YOUR_EMAIL@example.com">Email <span>Replace placeholder ↗</span></a><a href="https://www.linkedin.com/in/YOUR-LINKEDIN" target="_blank" rel="noreferrer">LinkedIn <span>Replace placeholder ↗</span></a><a href="https://github.com/YOUR-GITHUB" target="_blank" rel="noreferrer">GitHub <span>Replace placeholder ↗</span></a></div></section>
    </>}
